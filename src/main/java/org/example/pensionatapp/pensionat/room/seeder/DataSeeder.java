...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (roomRepository.count() == 0) {
            ...
            roomRepository.save(new Room("104", 2, 800));
            roomRepository.save(new Room("105", 2, 1200));
            roomRepository.save(new Room("106", 2, 1200));
            roomRepository.save(new Room("107", 2, 1200));
            roomRepository.save(new Room("108", 3, 2000));
            roomRepository.save(new Room("109", 3, 2000));
            roomRepository.save(new Room("110", 3, 2000));
            roomRepository.save(new Room("111", 4, 3000));
